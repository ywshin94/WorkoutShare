...
struct CanvasEditorView: View {
    ...
    // ✅ isPresented 바인딩 대신 onClose 클로저를 받음
    var onClose: () -> Void
        ...
        VStack(spacing: 0) {
            ...
            ScrollView(.vertical, showsIndicators: true) {
                ...
                VStack(spacing: 24) {
                                    ...
                                    Button(action: {
                                        ...
                                        .background(
                                            RoundedRectangle(cornerRadius: 8)
                                                ...
                                                .overlay(
                                                    RoundedRectangle(cornerRadius: 8)
                                                        .stroke(configuration.fontName == font.name ? Color.accentColor : Color.clear, lineWidth: 2)
                                                )
                                        )
                                    }
                                }
                    ...
                    Section(header: Text("표시 항목 선택").font(.caption).foregroundColor(.secondary)) {
